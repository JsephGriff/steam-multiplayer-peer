...
SteamPacketPeer::SteamPacketPeer(const void *p_buffer, uint32_t p_buffer_size, int transferMode, int p_transfer_channel) {
	...
	this->transfer_channel = p_transfer_channel;
}